...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public void reInit() {
		...
		Category autogenCategory = dbHandler.getCategory("Autogenerated");
		if (autogenCategory == null) {
			dbHandler.addCategory(new Category("Autogenerated", Integer
					.toHexString(context.getResources()
							.getColor(R.color.orange)), Integer
					.toHexString(context.getResources().getColor(
							R.color.orange_dark))));
		}
		...
		for (ListObject lo : totalList) {
			...
			if (lo.getTime() != null) {
				Log.d("ListObjectToAdd", "" + lo.getName() + ", cat: " + lo.getCategories().toString());
