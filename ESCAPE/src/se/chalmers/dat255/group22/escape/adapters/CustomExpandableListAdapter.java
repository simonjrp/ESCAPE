...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
	...
	/*
	 * Initialize lists, headers and hashmap
	 */
	private void initialize() {
		...
		headerList
				.add(context.getResources().getString(R.string.tomorrow_label));
		headerList.add(context.getResources()
				.getString(R.string.thisweek_label));

		headerList.add(context.getResources().getString(R.string.someday_label));

		objectDataMap.put(
				context.getResources().getString(R.string.today_label),
				todayEventList);
		objectDataMap.put(
		...
		if (getLOShouldBeVisible(listObject)) {
			...
			if (listObject.getTime() != null) {
				if (somedayEventList.contains(listObject)
						|| thisWeekEventList.contains(listObject)) {
